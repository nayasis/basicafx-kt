...
mavenPublishing {
	...
	pom {
		name        = project.name
		description = "Basic JavaFx library based on Kotlin"
		url         = "https://github.com/nayasis/basicafx-kt"
		licenses {
			license {
		...
		scm {
			url                 = "https://github.com/nayasis/basicafx-kt"
			connection          = "scm:git:github.com/nayasis/basicafx-kt.git"
			developerConnection = "scm:git:ssh://github.com/nayasis/basicafx-kt.git"
		}
	}
}
